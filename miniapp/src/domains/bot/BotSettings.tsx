...
import { Section, ToggleItem, Page, ProfileHeader, Avatar, FormInput, FormTextArea, ListItem, Loader, Button, ICON_SIZES } from '../../shared/components';
...
export const BotSettings: React.FC = () => {
  ...
  const { getBotById, refreshBots, loading: botsLoading, getBotAvatarUrl, updateBotAvatar } = useBots();
